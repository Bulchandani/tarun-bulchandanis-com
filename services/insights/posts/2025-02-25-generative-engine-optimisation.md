...
- No schema.org markup, or markup applied inconsistently. (See the [practitioner's guide](/services/insights/structured-data-modern-business-website/).)
- No `llms.txt`. (See [Understanding llms.txt](/services/insights/understanding-llms-txt/).)
- Thin service pages. The firm's underlying expertise is far greater than what the pages express.
- No FAQ markup. (See [FAQ schema as a discoverability lever](/services/insights/faq-schema-ai-search-visibility/).)
...
Each of these is independently fixable. The Retrofit tier of the [services line](/services/) is, in effect, a packaged remediation of the foundational items.
...
- A one-time foundational engagement to address the structural gaps (the [audit](/services/insights/audit-framework-ai-search-readiness/) and the [retrofit](/services/) packages cover this).
...
The [implementation roadmap](/services/insights/implementation-roadmap-ai-search-discoverability/) covers the sequencing. The [Authority tier](/services/) is the productised version of the sustained-cadence work.
